...
grant select on public.profiles to authenticated;grant select,insert on public.action_events to authenticated;grant select on public.challenge_groups,public.challenge_group_members,public.point_rules,public.rooms,public.room_slots,public.room_items,public.room_actions,public.room_action_entitlements,public.room_traps,public.daily_results to authenticated;grant select,insert on public.comments to authenticated;
